...
const NDRRMA_NE = neTime(C.RESCUE_AS_OF);
...
const LAKE_WARNING = `<div class="callout callout-alert">
  <p class="callout-title">ताल फुट्ने तत्काल जोखिम घटेको छ, सावधानी चाहिन्छ</p>
  <p>जलविज्ञान तथा मौसम विज्ञान विभागका अनुसार पानी आफैँ बाहिरिन थालेपछि अचानक ताल फुट्ने तत्काल जोखिम घटेको छ, Onlinekhabar ले जनाएको छ।</p>
  <p>विज्ञहरूले नयाँ पहिरोले फेरि बाढी ल्याउन सक्ने चेतावनी दिएका छन्। भोटेकोशी, त्रिशूली र नारायणीको किनारमा अधिकारीले सुरक्षित नभनेसम्म नजानुहोस्।</p>
  <p class="faint" style="margin-bottom:0;">स्रोत: जलविज्ञान तथा मौसम विज्ञान विभाग र विज्ञहरू, Onlinekhabar, २९ अगस्ट २०२६।</p>
</div>`;
...
function numbersNe() {
  return `<div class="numgrid">
    ...
    <div class="statbox"><span class="n crit">${ne(C.TOLL.missing)}</span><span class="l">नेपालमा बेपत्ता सूचीमा</span><span class="src">नेपाल प्रहरी, ${esc(MISSING_NE)}</span></div>
    ...
    <div class="statbox"><span class="n">${ne(C.TOLL.rescued)}</span><span class="l">उद्धार गरिएका</span><span class="src">NDRRMA, ${esc(NDRRMA_NE)}</span></div>
  ...
  <p class="updated-line"><strong>दुई मुख्य सङ्ख्या आफ्नै घडीसँग पढ्नुहोस्।</strong> नेपाल प्रहरीको ${esc(TOLL_NE)} को बुलेटिनमा मृत्यु सङ्ख्या ${ne(C.TOLL.deadNepal)} छ। नेपाल प्रहरीको ${esc(MISSING_NE)} को अपडेटमा ${ne(C.TOLL.missing)} जना सम्पर्कविहीन छन्। सम्पर्कविहीन हुनु मृत्यु पुष्टि हुनु होइन।</p>`;
}
...
export function neEvent(ctx) {
  ...
  const faq = faqBlock([
    {
      q: 'रसुवामा के भयो?',
      a: `<p>२०२६ अगस्ट २६ को बिहान करिब ९ बजे तिब्बततर्फबाट भोटेकोशी नदी हुँदै अचानक बाढी रसुवा जिल्लामा पस्यो। तिमुरे, स्याफ्रुबेसी, रसुवागढी नाका र उत्तरी रसुवाका करिब एक दर्जन नदी किनारका बस्ती सबैभन्दा बढी प्रभावित भए। पानी त्रिशूली हुँदै नारायणीसम्म पुग्यो। ${esc(TOLL_NE)} सम्म नेपाल प्रहरीले ${ne(C.TOLL.deadNepal)} जनाको मृत्यु पुष्टि गरेको छ।</p>`,
    },
    {
      q: 'बाढीको कारण के हो?',
...
<p>पहिलो दुई दिनमा सङ्ख्या बारम्बार बढ्यो, किनभने खोजी टोली सम्पर्कविहीन भएका ठाउँमा पुग्दै गए। बुधबार साँझ प्रधानमन्त्री कार्यालयले ९५ र प्राधिकरणले ७२ भनेको थियो; ${esc(neTime(C.TOLL_EARLIER_AS_OF))} मा नेपाल प्रहरीको सङ्ख्या ${ne(C.TOLL.deadNepalEarlier)} पुग्यो, र ${esc(TOLL_NE)} को NDRRMA अपडेटमा <strong>${ne(C.TOLL.deadNepal)}</strong> पुग्यो। यही कारण यहाँको हरेक सङ्ख्या अस्थायी हो।</p>

<h3>कुन जिल्लामा कति शव फेला परे</h3>
${table(['जिल्ला', 'शव फेला परेको'], C.BODIES_BY_DISTRICT.map(([d, n]) => [esc(NE_DISTRICTS[d] || d), `<span class="num">${ne(n)}</span>`]).concat([['<strong>यो सूचीको जम्मा</strong>', `<strong class="num">${ne(C.BODIES_BY_DISTRICT.reduce((a, [, n]) => a + n, 0))}</strong>`]]), `${esc(C.BODIES_SOURCE)}, ${esc(BODIES_NE)}। जिल्लागत विवरणको जम्मा माथिको राष्ट्रिय कुलसँग मिल्छ। तालिकामा भएको जिल्ला शव फेला परेको ठाउँ हो, मृतकको स्थायी ठेगाना होइन।`)}
...
<p>नेपाली सेना, सशस्त्र प्रहरी बल र नेपाल प्रहरीले सैनिक तथा निजी हेलिकप्टरसहित खोजी र उद्धार गरिरहेका छन्। NDRRMA का अनुसार ${esc(NDRRMA_NE)} सम्म <strong>${ne(C.TOLL.rescued)} जना</strong> उद्धार गरिएका छन्। पछिल्लो विवरणमा निकाय वा स्थानअनुसारको छुट्टै विवरण छैन, त्यसैले यहाँ उप-विवरण अनुमान गरिएको छैन।</p>
...
<p>मृत्यु, सम्पर्कविहीन र उद्धारको पछिल्लो सङ्ख्या NDRRMA को ${esc(NDRRMA_NE)} को अपडेटबाट लिइएको हो। क्षति र प्रतिकार्यका पुराना विवरण संयुक्त राष्ट्रसंघीय OCHA को २७ अगस्टको स्थिति विवरणबाट लिइएका हुन्। दुई स्रोत बाझिए कम भएको तर पुष्टि भएको सङ्ख्या राखिन्छ, स्रोत र समयसहित।</p>
...
<p>नेपाल प्रहरीको ${esc(MISSING_NE)} को अपडेटमा नेपालभित्र <strong>${ne(C.TOLL.missing)} जना</strong> सम्पर्कविहीन सूचीमा छन्।</p>
${table(['समूह', 'बेपत्ता सूचीमा'], C.MISSING_BREAKDOWN.map(([k, n]) => [esc(NE_MISSING_GROUPS[k] || k), `<span class="num">${ne(n)}</span>`]).concat([['<strong>त्यो सूचीको जम्मा</strong>', `<strong class="num">${ne(C.MISSING_BREAKDOWN_TOTAL)}</strong>`]]), `नेपाल प्रहरी, ${esc(MISSING_BREAKDOWN_NE)}। हालको प्रहरी सङ्ख्या ${ne(C.TOLL.missing)} हो, तर नयाँ समूहगत विवरण आएको छैन।`)}
